...
class PostprocessingExecutor:
    def __init__(self, processors=None, postprocessing_configuration=None, dataset_name='custom', dataset_meta=None, state=None):
        self._processors = []
        ...
        if not processors and not postprocessing_configuration:
            return
        if processors:
            self._processors = processors

        if postprocessing_configuration:
            for config in postprocessing_configuration:
