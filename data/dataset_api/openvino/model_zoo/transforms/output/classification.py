...
class ClassificationPostprocessor:
    def __init__(self, output_tensor, additional_transforms=None):
    ...
    def _get_preds(self, predictions):
        ...
        predictions[self.output_tensor] if self.output_tensor is not None else next(iter(predictions.values()))
